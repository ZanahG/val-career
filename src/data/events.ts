    ...
    choices:[
      {
        ...
        effects:{communication:2,mental:1,currentStage:"Amateur"},
...

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{communication:3,gameSense:1,currentStage:"Amateur"},
      ...
      },
      {
        ...
        effects:{aim:3,communication:-1,currentStage:"Amateur"},
        nextEventId:"high-pressure-scrim",
      },
    ],
  },
    ...
    choices:[
      {
        ...
        effects:{mental:3,consistency:-1,currentStage:"Amateur"},
      ...
      },
      {
        ...
        effects:{gameSense:2,communication:2,currentStage:"Amateur"},
        nextEventId:"first-team-practice",
      },
      {
...

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{communication:3,consistency:1,currentStage:"Amateur"},
        nextEventId:"communication-drill",
      },
    ],
  },

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{mental:3,consistency:2},
        nextEventId:"second-opportunity",
      },
    ],
  },
    ...
    choices:[
      {
        ...
        effects:{communication:2,gameSense:2,currentStage:"Amateur"},
        nextEventId:"first-team-practice",
      },
      {
        id:"manager-impact",
      ...
      },
      {
        ...
        effects:{gameSense:3,currentStage:"Amateur"},
    ...
    choices:[
      {
        ...
        effects:{communication:2,consistency:2,gameSense:1},
...

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{communication:2,gameSense:2},
        nextEventId:"tactical-meeting",
      },
      {
        ...
        effects:{consistency:2,communication:-1,aim:1},
        nextEventId:"qualifier-preparation",
      },
    ],
  },
    ...
    choices:[
      {
        ...
        effects:{consistency:3,gameSense:-1,currentStage:"Amateur"},
      ...
      },
      {
        ...
        effects:{gameSense:3,mental:-1,currentStage:"Amateur"},
        nextEventId:"qualifier-match",
      },
      {
        ...
        effects:{aim:3,consistency:-1,currentStage:"Amateur"},
        nextEventId:"qualifier-match",
      },
    ],
  },
...

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{aim:2,mental:2,consistency:-1},
        nextEventId:"qualifier-overtime",
      },
      {
        id:"qualifier-calls",
...

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{communication:3,clutch:1,mental:1},
        nextEventId:"post-qualifier-review",
      },
    ],
  },
    ...
    choices:[
      {
        ...
        effects:{communication:2,consistency:2,currentStage:"Amateur"},
      ...
      },
      {
        ...
        effects:{aim:2,mental:2,currentStage:"Amateur"},
        nextEventId:"trial-week",
      },
      {
...

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{aim:2,mental:2,gameSense:-1},
        nextEventId:"pressure-series",
      },
    ],
  },
...

  {
    ...
    choices:[
      ...
      },
      {
        ...
        effects:{consistency:2,mental:2},
      },
      {
        id:"tier2-ceiling",
        ...
        effects:{aim:2,gameSense:2,mental:-1},
      },
    ],
  },
];
